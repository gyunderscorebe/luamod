...
return {
    ...
    say = {
        ...
        text = {
            ...
            disconnect = "%s \f2HAS LEFT THE SERVER !!!",
            ...
            geo_city = '%s \fP%s\f2, ',
            chkeck_ban_name_message = '\f3Name contains a forbidden word on this playground. It is prohibited by the rules.',
            not_connect_same_name_message = ' This name is already used by a player, present here. It is prohibited by the rules.',
            not_connect_old_same_name_message = ' This name is already used by players who are here. It is prohibited by the rules.',
            not_rename_message = " \f2Player %s \f2tried to change the name on the \f3%s\f2. It is prohibited by the rules.",
            active_chkeck_ban_name_message = '%s \f2Name contains a forbidden word on this playground. It is prohibited by the rules.',
            not_allow_same_name_message = "\f2Player %s \f2tried to change the name on the \f3%s\f2. This name is already used by a player, present here. It is prohibited by the rules.",
            not_allow_old_same_name_message = "\f2Player %s \f2tried to change the name on the \f3%s\f2. This name is already used by players who are here. It is prohibited by the rules.",
            rename_message = "\f3!!! \f2Player name changes to %s \f3%s",
            not_admin_rename_kick_message = "%s \f9Administrator can not change the name \f3!!! \f9It is prohibited by the rules.",
            not_admin_rename_message = "Player \f3%s \f2tried to become an administrator. Follow the rules, too",
    ...
    cn = {
        ...
        -- указать сообщение  причины выхода
        say_disconnect_message = true,
        -- запретить вход с одинаковыми именами
        not_connect_same_name = true,
        -- сказать всем  что пытался зайти игрок с именем уже присутствующим в игре
        say_not_connect_same_name = true,
        -- запретить вход с именем, если действующий игрок уже его использовал в игре
        not_connect_old_same_name = false,
        -- сказать всем  что пытался зайти игрок с именем которое уже было у  присутствующего в игре
        say_not_connect_old_same_name = true,
